...
# Source: https://wiki.archlinux.org/index.php/PulseAudio/Troubleshooting#Script_for_reloading_module-echo-cancel
...
# beamforming - support dropped upstream in webrtc
#aecArgs="$aecArgs beamforming=1 mic_geometry=-0.04,0,0,0.04,0,0 target_direction=1.5,0,0"
